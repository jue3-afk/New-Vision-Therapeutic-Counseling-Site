export const siteContent = {
  practiceName: "New Vision Therapeutic Counseling",
  therapistName: "Deborah Ejiofor",
  credentials: "Licensed Professional Counselor (LPC), National Certified Counselor (NCC)",
